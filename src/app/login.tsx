  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
      <ScrollView contentContainerStyle={styles.authScrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.authSubtitle}>Access your trips and transport info in seconds.</Text>
        
        <View style={styles.inputContainer}>
          <Text style={styles.inputEmoji}>✉️</Text>
          <TextInput style={styles.textInput} placeholder="Enter Email" placeholderTextColor="#9CA3AF" defaultValue="john.cena@transit.com" />
        </View>

        <View style={styles.inputContainer}>
          <Text style={styles.inputEmoji}>🔒</Text>
          <TextInput style={styles.textInput} placeholder="Enter password" secureTextEntry={!showPassword} placeholderTextColor="#9CA3AF" defaultValue="password123" />
